	...
	$(document).ready(function () {
		...
		function styleSwitch(cookie){
			if(cookie==0){
				...
				$('head').append('<link rel="stylesheet" href="sites/all/themes/zentropy/css/style-mobile.css" media="screen" id="style-mobile">');
				$('head').append('<link rel="stylesheet" href="sites/all/themes/zentropy/css/skeleton-mobile.css" media="screen" id="skeleton-mobile">');
